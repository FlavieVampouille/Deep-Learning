...
model = Sequential()
# Q3
# add a lstm layer in which the input is be the output of the ConvNet
if False:
    ...
    model.add(Convolution1D(nb_filter=nb_filter,
                        ...
                        activation='relu',
                        subsample_length=1))
    model.add(LSTM(nhid,return_sequences = True, consume_less = "cpu"))
elif False:
    model.add(Embedding(vocab_size,
                    embed_dim,
                    input_length=maxlen,
    ...
    model.add(Convolution1D(nb_filter=nb_filter,
                        ...
                        activation='relu',
                        subsample_length=1))
    model.add(LSTM(nhid, return_sequences = True, consume_less = "cpu", dropout_W=0.2, dropout_U=0.2))
elif False:
    model.add(Embedding(vocab_size,
                    embed_dim,
                    input_length=maxlen,
    ...
    model.add(Convolution1D(nb_filter=nb_filter,
                        ...
                        activation='relu',
                        subsample_length=1))
    model.add(LSTM(nhid,return_sequences = True, consume_less = "cpu", activation="sigmoid"))
else:
    model.add(Embedding(vocab_size,
                    embed_dim,
                    input_length=maxlen,
    ...
    model.add(Convolution1D(nb_filter=nb_filter,
                        ...
                        activation='relu',
                        subsample_length=1))
    model.add(LSTM(nhid,return_sequences = True, consume_less = "cpu", activation="hard_sigmoid"))
